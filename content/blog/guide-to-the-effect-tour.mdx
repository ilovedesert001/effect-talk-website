...
<!-- Screenshot: The /tour index page showing the lesson list with group headings. Ideally capture at least two groups (e.g., Fundamentals and Composition) with a few lessons visible. If possible, show one lesson marked "Done" with the green checkmark badge. -->
...
<!-- Screenshot: A single tour lesson step showing the two-column layout: explanation text on the left (with hints if visible), the code editor on the right (showing the Anti-pattern/Solution tabs), and the step navigation bar at the bottom with the circular step indicators. -->
